...
val=val.substr(0,val.length-2);if(val.length>60){val=val.substr(0,57)+'...'}}
if(activeItems.length==document.getElementById(context._getItemListIdentifier()).querySelectorAll('ul li').length){val='All available fertilizers in the system'}
