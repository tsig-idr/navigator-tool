CZ = STD_CSV2ARRAY (CONCAT ('sheetscript/G3/', 'CZ.csv'))
Crops = STD_CSV2ARRAY (CONCAT ('sheetscript/G3/', 'Crops.csv'))
EF_rew = STD_CSV2ARRAY (CONCAT ('sheetscript/G3/', 'EF_rew.csv'))
EF_soil = STD_CSV2ARRAY (CONCAT ('sheetscript/G3/', 'EF_soil.csv'))
...
ILref = STD_CSV2ARRAY (CONCAT ('sheetscript/G3/', 'InputLevel.csv'))
FMGref = STD_CSV2ARRAY (CONCAT ('sheetscript/G3/', 'FMG.csv'))
FLUref = STD_CSV2ARRAY (CONCAT ('sheetscript/G3/', 'FLU.csv'))
