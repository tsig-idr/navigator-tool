SOC4forest = STD_CSV2ARRAY (CONCAT ('sheetscript/G4/', 'SOC4forest.csv'))
BCEF = STD_CSV2ARRAY (CONCAT ('sheetscript/G4/', 'BCEF.csv'))
SOC4LUC = STD_CSV2ARRAY (CONCAT ('sheetscript/G4/', 'SOC4LUC.csv'))
SOC4trees = STD_CSV2ARRAY (CONCAT ('sheetscript/G4/', 'SOC4trees.csv'))
SOC4shrubby = STD_CSV2ARRAY (CONCAT ('sheetscript/G4/', 'SOC4shrubby.csv'))
SOC4low = STD_CSV2ARRAY (CONCAT ('sheetscript/G4/', 'SOC4low.csv'))
