CSVAgro = SP_CSV2ARRAY(CONCAT('tmp/F1/', CONCAT(uid, '_CSVAgro.csv')))
Clima = SP_CSV2ARRAY(CONCAT('tmp/F1/', CONCAT(uid, '_Clima.csv')))
Meteo = SP_CSV2ARRAY(CONCAT('tmp/F1/', CONCAT(uid, '_Meteo.csv')))
Fertiliza = SP_CSV2ARRAY(CONCAT('tmp/F1/', CONCAT(uid, '_Fertiliza.csv')))
...
NDVIreal = SP_CSV2ARRAY(CONCAT('tmp/F1/', CONCAT(uid, '_NDVI_real.csv')))
NDVIreali = LINTER4DATES (NDVIreal, 1)
NDVItipo = SP_CSV2ARRAY(CONCAT('tmp/F1/', CONCAT(uid, '_NDVI_tipo.csv')))
