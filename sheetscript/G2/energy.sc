CO24electricity = STD_CSV2ARRAY (CONCAT ('sheetscript/G2/', 'CO24electricity.csv'))
CO24energy = STD_CSV2ARRAY (CONCAT ('sheetscript/G2/', 'CO24energy.csv'))
CO24biomass = STD_CSV2ARRAY (CONCAT ('sheetscript/G2/', 'CO24biomass.csv'))
CO24fuels = STD_CSV2ARRAY (CONCAT ('sheetscript/G2/', 'CO24fuels.csv'))
